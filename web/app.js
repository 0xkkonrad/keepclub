...
const FIG_NO_PEN = /(^|\s)(f-dash|f-dash-acc|f-dash-red|f-cut|f-jack|f-wash|f-arc|f-arc-on|f-sail|f-fender|fill-[a-z]+)(\s|$)/;

/* Set a figure drawing itself.
 *
 * Which elements can take a pen is decided here rather than in the build, on
 * purpose: figures.json is generated by two different course repositories, and
 * a rule that lives in one stylesheet is a rule that cannot fall out of step
 * with the other course. It is one pass over ~40 elements when a card renders.
 *
