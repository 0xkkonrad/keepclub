...
## Bow, stern, port, starboard — what does each mean? {ref=terms}
...
![diagram](fig:hull-plan@bow,stern,beam)

## Amidships {ref=terms}

## Beam (two meanings) {ref=terms}

## Ahead, astern, abeam, abaft, forward of the beam {ref=terms}
...
## Bilge, sole, bulkhead {ref=terms}

## Pulpit, pushpit, stanchions, guardrails, jackstay {ref=terms}

## Draught {ref=terms}

## Air draught {ref=terms}
...
## Heel versus list {ref=terms}

## The three rotational motions of a boat at sea {ref=terms}
...
## Name the three sides and three corners of a mainsail. {ref=terms}

## Standing rigging versus running rigging {ref=terms}

## Halyard versus sheet {ref=terms}

## Topping lift {ref=terms}

## Genoa versus jib {ref=terms}
...
![diagram](fig:rigging@kicker)

## Windward and leeward {ref=terms}

## Lee shore — and why it matters {ref=terms}
...
## What are the commands for tacking and gybing? {ref=handling nofig}
