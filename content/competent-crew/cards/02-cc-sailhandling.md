...
![diagram](fig:sail-parts@head,tack,clew,luff,foot,boom,mast)

## How do you rig a headsail correctly? {ref=handling}
...
## How do you put a reef in with slab reefing? {ref=handling}

## How do you shake out a reef? {ref=handling}

## What is a preventer and when do you rig it? {ref=handling}
