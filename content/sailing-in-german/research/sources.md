...
Checked 2026-09-22. Definitions are written for this course. These references
support terminology; no single dictionary is treated as infallible.

- [Sailnator: Begriffsbestimmung](https://sailnator.de/begriffe/) — sailing-school explanations of boat parts, sail edges and corners, sheets and halyards.
- [Duden: Freibord](https://www.duden.de/rechtschreibung/Freibord) — masculine noun: **der Freibord**. The independent review caught and corrected the draft's neuter article.
- [Segeln lernen: sailing lexicon](https://www.segeln-lernen.de/segellexikon.html) — German sailing definitions, including wind, manoeuvres and hardware; entries are also indexed by initial letter.
